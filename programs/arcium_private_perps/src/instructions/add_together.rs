use crate::{
    constants::COMP_DEF_OFFSET_ADD_TOGETHER,
    error::ErrorCode,
    ArciumSignerAccount,
    ID,
    ID_CONST,
...
pub fn init_add_together_comp_def_handler(ctx: Context<InitAddTogetherCompDef>) -> Result<()> {
    init_comp_def(ctx.accounts, None, None)?;
    Ok(())
}

pub fn add_together_handler(
...
pub fn add_together_callback_handler(
