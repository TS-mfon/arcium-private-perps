...
import { ArciumPrivatePerps } from "../target/types/arcium_private_perps";
...
describe("ArciumPrivatePerps", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());
  const program = anchor.workspace
    .ArciumPrivatePerps as Program<ArciumPrivatePerps>;
  ...
  async function initAddTogetherCompDef(
    program: Program<ArciumPrivatePerps>,
